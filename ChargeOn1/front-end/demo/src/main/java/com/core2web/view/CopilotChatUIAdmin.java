...
public class CopilotChatUIAdmin {
    ...
    private static final String ADMIN_SYSTEM_PROMPT =
            "You are ChargeOn AI Assistant, an expert AI assistant for EV Charging Fleet Administrators. " +
            "Provide concise, highly accurate, and helpful information about bus telemetry, battery levels, depot management, " +
            "charging station fault reports, route scheduling, and emergency bookings. Maintain a professional, helpful tone. " +
            CHARGEON_TECH_CONTEXT +
            "Only answer questions related to the ChargeOn platform, EV charging fleet administration, or how " +
    ...
    public static void show(Stage stage) {
        AdminDashboard.goTo("AI Assistant");
    }

    static VBox buildMainContent() {
        return new CopilotChatUIAdmin().createCopilotContent();
    }

    private VBox createCopilotContent() {
        ...
        chatArea.setBottom(bottomSection);

        showInitialGreeting();

        wrapper.getChildren().add(chatArea);
    ...
    private HBox createHeader() {
        ...
        Label subtitleLabel = new Label("Admin AI Assistant · select a live bus for telemetry");
    ...
    private VBox createBottomSection() {
        ...
        String[] suggestedPrompts = {
                ...
                "Analyze pending emergency bookings",
    ...
    private void showInitialGreeting() {
        ...
        renderAIMessage(
                "Hello Admin! 👋 I'm your ChargeOn AI Assistant powered by Groq.\n\n" +
                "Monitoring Bus #07 Telemetry · Depot Chargers Active · Shift ends 15:00\n\n" +
                "Type your prompt below or select a suggested topic to chat!"
        );
    }
