...
public class DriverProfile {
    ...
    public static ScrollPane buildMainContent() {
        ...
        backButton.setOnAction(e ->
                DriverDashboard.goTo("Dashboard")
        );
        ...
        Label subtitle = new Label(
                "Manage your driver profile and contact information"
        );
        ...
        HBox pictureActions = new HBox(10);
        pictureActions.setAlignment(Pos.CENTER_LEFT);
        ...
        if (driver != null) {
            ...
            if (driver.getName() != null
                ...
                initials.setText(
                        getInitials(driver.getName())
                );
            }

            if (driver.getProfileImageUrl() != null
                    && !driver.getProfileImageUrl().isEmpty()) {
        ...
        changePicture.setOnAction(e -> {
            ...
            if (imageUrl == null) {
                ...
                System.out.println(
                        "Driver profile picture upload failed."
                );
            ...
            boolean saved =
                    driverController.updateProfileImageUrl(
                            imageUrl
                    );
        ...
        removePicture.setOnAction(e -> {
            ...
            if (!removed) {
                ...
                System.out.println(
                        "Failed to remove driver profile picture."
                );
            ...
            System.out.println(
                    "Driver profile picture removed successfully."
            );
        });
        ...
        accountCard.setPadding(new Insets(18));
        ...
        if (driver != null) {
            ...
            Bus assignedBus = busController.getBusForCurrentDriver();

            if (assignedBus != null
                    && assignedBus.getBusCode() != null
                    && !assignedBus.getBusCode().isEmpty()) {

                busValue.setText(assignedBus.getBusCode());
            }
        }


        VBox contactCard = new VBox(12);
        contactCard.getStyleClass().add("card");
        contactCard.setPadding(new Insets(18));
        ...
        saveButton.setOnAction(e -> {
            ...
            boolean updated =
                    driverController.updatePhone(phone);

            if (updated) {

                System.out.println(
                        "Driver profile changes saved successfully."
                );

            } else {

                System.out.println(
                        "Failed to save driver profile changes."
                );
            }
        });
